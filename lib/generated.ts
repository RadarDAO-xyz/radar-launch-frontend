// Generated by @wagmi/cli@1.3.0 on 8/31/2023 at 4:14:33 PM
import {
  useContractRead,
...
export const radarEditionsABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'hashOne', internalType: 'bytes32', type: 'bytes32' },
      { name: 'hashTwo', internalType: 'bytes32', type: 'bytes32' },
      { name: 'hashThree', internalType: 'bytes32', type: 'bytes32' },
    ],
    name: 'believeProject',
    outputs: [],
  },
