  ...
  return (
    <_Component className="featured-project-wrapper" tag="div">
      ...
      <_Builtin.Block className="project-image" tag="div">
        <_Builtin.HtmlEmbed
          className="video-html opacity-70 cursor-default"
      ...
      <_Builtin.Block className="feature-project-div" tag="div">
        ...
        >
          <_Builtin.Block className="div-block-97" tag="div">
            <_Builtin.Paragraph className="featured-project-title">
              {"TITLe"}
            </_Builtin.Paragraph>
        ...
        <_Builtin.Block className="collect-wrapper main" tag="div">
          <_Builtin.Block className="div-block-30" tag="div">
            <_Builtin.Block className="small-text" tag="div">
              {"3728 • supporters"}
            </_Builtin.Block>
            <_Builtin.Block className="_20px-width" tag="div" />
          </_Builtin.Block>
          <_Builtin.Block className="small-text" tag="div">
            {"00:00:00"}
          </_Builtin.Block>
