...
export function FundingPoolProjectsGrid({ as: _Component = _Builtin.Section }) {
  ...
  return (
    ...
    >
      ...
      >
        <_Builtin.FormForm
          className={_utils.cx(_styles, "form-7")}
          name="email-form"
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "fs-checkbox_row")}
            tag="div"
          >
            <_Builtin.FormCheckboxWrapper
              className={_utils.cx(_styles, "fs-checkbox_field-4-2")}
            >
              <_Builtin.FormCheckboxInput
                className={_utils.cx(_styles, "fs-checkbox_button-4-2")}
                inputType="custom"
                type="checkbox"
                name="Checkbox-4-A-3"
                data-name="Checkbox 4 A 3"
                required={false}
                checked={false}
                id="Checkbox-4-A-3"
              />
              <_Builtin.FormInlineLabel
                className={_utils.cx(_styles, "fs-checkbox_label-4-2")}
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "div-block-92")}
            tag="div"
          >
            <_Builtin.FormTextInput
              className={_utils.cx(_styles, "fs-search_field-1")}
              autoFocus={false}
              maxLength={256}
              name="Search-bard-2"
              data-name="Search Bard 2"
              placeholder="Search here"
              type="text"
              disabled={false}
              required={true}
              fs-cmsfilter-field="*"
              aria-label="add_description_here"
              id="Search-bard-2"
            />
          </_Builtin.Block>
        </_Builtin.FormForm>
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "funding-pool-brief-wrapper")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4cfa9"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "brief-wrapper")}
              tag="div"
            >
              <_Builtin.Block tag="div">
                <_Builtin.Block
                  className={_utils.cx(_styles, "briefs-labels")}
                  tag="div"
                >
                  {"Brief:"}
                </_Builtin.Block>
            ...
            >
              <_Builtin.HtmlEmbed
                className={_utils.cx(_styles, "video-html")}
            ...
            >
              ...
              >
                ...
                <_Builtin.Block
                  className={_utils.cx(_styles, "arrow-diagonal")}
                  tag="div"
                >
                  {"↗"}
                </_Builtin.Block>
              ...
              >
                <_Builtin.Paragraph
                  className={_utils.cx(_styles, "project-byline")}
                  dyn={{
                    bind: {},
                  }}
                >
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "bottom-half-of-content")}
            tag="div"
          >
            <_Builtin.Block
              ...
              tag="div"
            >
              <_Builtin.Block className={_utils.cx(_styles, "data")} tag="div">
                <_Builtin.Block
                  className={_utils.cx(_styles, "supporters")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "amount-of-supporters")}
                    dyn={{
                      bind: {},
                    }}
                    tag="div"
                ...
                <_Builtin.Block
                  className={_utils.cx(_styles, "count-block")}
                  tag="div"
                >
                  <_Builtin.HtmlEmbed
                  ...
                  />
                  <_Builtin.Block
                    className={_utils.cx(_styles, "count-wrap")}
                    tag="div"
                  >
                    <_Builtin.Block
                      className={_utils.cx(_styles, "days")}
                      tag="div"
                      id="days"
                    >
                      {"0"}
                    ...
                    <_Builtin.Block
                      className={_utils.cx(_styles, "count-text")}
                      tag="div"
                    >
                      {"d"}
                    </_Builtin.Block>
                  ...
                  >
                    <_Builtin.Block
                      className={_utils.cx(_styles, "hours")}
                      tag="div"
                      id="hours"
                    >
                      {"0"}
                  ...
                  >
                    <_Builtin.Block
                      className={_utils.cx(_styles, "minutes")}
                      tag="div"
                      id="minutes"
                    >
                      {"0"}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4cfd8"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4d007"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4d036"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4d065"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4d094"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4d0c3"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "project-block", "featured")}
          data-w-id="02740f48-07db-aceb-a682-69a887d4d0f2"
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "top-half-of-content")}
